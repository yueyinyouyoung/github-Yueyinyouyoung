/// A sandbox to play with shape sprites in a physics world.
public class SpritePlayground {
    public init() {
        // Sets up the scene for physics.
    ...
    /// Creates a measurement line. Used to see how high you can stack sprites.
